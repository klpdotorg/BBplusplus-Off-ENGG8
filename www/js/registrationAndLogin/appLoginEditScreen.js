...
Game.appLoginEditScreen.prototype = {
	...
	create: function (game) {
		...
		_this.basePath = cordova.file.externalRootDirectory + "Android/data/com.akshara.BBplusplusOffEngG8/Files/Download/.gameFilesBB++V10_2/www/";
		...
		if (_this.user.language == "English") {
			...
			_this.fileCheck = [
				[_this.basePath + "questionSounds/AL-DIV-G8/Hindi", _this.user.language + "/HINquestionSounds.zip"],
				[_this.basePath + "assets/commonAssets", "Assets1.zip"],
				[_this.basePath + "assets/demoVideos", "Assets2.zip"],
				// [_this.basePath + "assets/exitAssets", _this.user.language ) + "/Assets3.zip"],
				[_this.basePath + "assets/gradeAssets", "Assets4.zip"],
			...
			_this.fileCheck = [
				[_this.basePath + "questionSounds/AL-DIV-G8/Kannada", _this.user.language + "/KANquestionSounds.zip"],
				[_this.basePath + "assets/commonAssets", "Assets1.zip"],
				[_this.basePath + "assets/demoVideos", "Assets2.zip"],
				// [_this.basePath + "assets/exitAssets", _this.user.language ) + "/Assets3.zip"],
				[_this.basePath + "assets/gradeAssets", "Assets4.zip"],
			...
			_this.fileCheck = [
				[_this.basePath + "questionSounds/AL-DIV-G8/Odiya", _this.user.language + "/ODIquestionSounds.zip"],
				[_this.basePath + "assets/commonAssets", "Assets1.zip"],
				[_this.basePath + "assets/demoVideos", "Assets2.zip"],
				// [_this.basePath + "assets/exitAssets", _this.user.language ) + "/Assets3.zip"],
				[_this.basePath + "assets/gradeAssets", "Assets4.zip"],
		...
		// }
			...
			_this.fileCheck = [
				[_this.basePath + "questionSounds/AL-DIV-G8/Marathi", _this.user.language + "/MARquestionSounds.zip"],
				[_this.basePath + "assets/commonAssets", "Assets1.zip"],
				[_this.basePath + "assets/demoVideos", "Assets2.zip"],
				// [_this.basePath + "assets/exitAssets", _this.user.language ) + "/Assets3.zip"],
				[_this.basePath + "assets/gradeAssets", "Assets4.zip"],
	...
	checkIfAllAssetsPresent: function () {
		if (_this.counter < _this.fileCheck.length) {
			...
			window.baseUrl = cordova.file.externalRootDirectory + "Android/data/com.akshara.BBplusplusOffEngG8/Files/Download/.gameFilesBB++V10_2/www/";//cordova.file.externalDataDirectory + 
